...
function ProjectSideMenu() {
  ...
  const tabs: Taabs[] = [
    {
      iconwhite: DefineWhite,
      icon: DefineImg,
      label: "Define",
      component: Define,
    },
    {
      iconwhite: MeasureImgWhite,
      icon: MeasureImg,
      label: "Measure",
      component: Measure,
    },
    {
      iconwhite: AnalyzeWhite,
      icon: AnalyzeImg,
      label: "Analyze",
      component: Analyze,
    },
    {
      iconwhite: ValidateWhite,
      icon: ValidateImg,
      label: "Validate / Improve",
      component: Validate,
    },
    {
      iconwhite: ControlWhite,
      icon: ControlImg,
      label: "Control",
      component: Control,
    },
    {
      iconwhite: ProjectWhite,
      icon: ProjectImg,
      ...
      <Card>
        <CardContent style={{ padding: "0" }}>
          ...
          >
            ...
            >
              {tabs.map((tab: Taabs, index: number) => {
                return tabSection(index, tab);
              })}
            </Tabs>
            ;
            <Box width={"100%"}>
      ...
      <Tab
        label={
          <div style={{ display: "flex", justifyContent: "left" }}>
            ...
            {value === index && (
              <img src={tab.iconwhite} alt="Control" width={20} height={20} />
            )}{" "}
            <div style={{ marginLeft: 9 }}>{tab.label}</div>
          </div>
        }
        {...a11yProps(index)}
        className="tabsBg"

...
function ProcessAudit() {
    ...
    const [isClicked, setIsClicked] = React.useState<String>(new String(null));
    const [isUpdate, setIsUpdate] = React.useState<boolean>(true);
    const [initialRowsProcessDetails, setInitialRowsProcessDetails] = React.useState<GridRowsProp>([]);
            ...
            <Box>
                <Card>
                    <CardContent style={{ padding: '0' }}>
                        <FullFeaturedCrudGrid hasAttachment={false} tableTitle='Audit' buttonTitle='Add Audit' initialColumns={columns} initialRows={initialRows} data={TableType.Audit} tab={TabType.Process} onSelect={onSelect}></FullFeaturedCrudGrid>
                        {isUpdate &&
                            <FullFeaturedCrudGrid hasAttachment={false} tableTitle='Audit Findings' initialColumns={columnsDetails} initialRows={initialRowsProcessDetails} data={TableType.Detail} tab={TabType.Process} buttonTitle='Add Finding' isClicked={isClicked}></FullFeaturedCrudGrid>}
                    </CardContent>
                </Card>
            </Box>
        </>

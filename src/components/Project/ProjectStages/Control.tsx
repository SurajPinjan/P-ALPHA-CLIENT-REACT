            ...
            <Box>
                <Card>
                    <CardContent >
                        ...
                        <FullFeaturedCrudGrid hasAttachment={true} tableTitle='Control Against Actions' buttonTitle='Add Control' initialColumns={columnsDetails} initialRows={initialRows} data={TableType.Audit} tab={TabType.Process}></FullFeaturedCrudGrid>
                    </CardContent>
                </Card>
            </Box>
            <Box marginTop={2}>

import { AppBar, Button, FormControlLabel, FormGroup, Grid, Switch, Tab, Table, TableContainer, TableRow, Tabs, Typography, styled } from "@mui/material";
import { SetStateAction, useState } from 'react';
import { Panel } from "../ProjectDetails";
import { Paper, TableBody, TableCell, Tooltip, TextField, CardContent, Card, } from "@mui/material";
...
function resourceData(id: number, name: string, calories: number, fat: string | number, carbs: string | number, protein: string | number, actions: string | number) {
    return { id, name, calories, fat, carbs, protein, actions };
}

const tableRows = [
    resourceData(1, 'G.T. Madhupatil', 1127757, 'Movement_Plan', '-', 'Project-Lead', ''),
    ...
    return (
        ...
        <BoxStyled style={{ padding: '' }}>
                        ...
                        <Card>
                            <CardContent style={{ paddingBottom: 1 }}>
                                ...
                                <Box display={'flex'} justifyContent={'center'} marginTop={2}>
                                    <ButtonStyle variant="contained">Click here to upload</ButtonStyle>
                                </Box>
                            </CardContent>
                        </Card>
                    </Grid>
                    <Grid item xs={6}>
                        <Card>
                            <CardContent style={{ paddingBottom: 1 }}>
                                ...
                                <Textarea aria-label="empty textarea" label='Enter Your Message Here' row={3} />
                                <Box display={'flex'} justifyContent={'center'} marginTop={2}>
                                    <ButtonStyle variant="contained">Click here to upload</ButtonStyle>
                                </Box>
                            </CardContent>
            ...
            <Panel value={index} index={1}>
                        ...
                        <Table aria-label="sticky table">
                            <TableHeadStyled >
                                <TableRowStyled>
                                    ...
                                    <TableCellStyled align="center" colSpan={2} style={{ fontWeight: 'bold' }}>
                                        Score
                                    </TableCellStyled>
                                    <TableCellStyled align="center" colSpan={2} style={{ fontWeight: 'bold' }}>
                                        Plan
                            ...
                            <TableBody>
                                <TableRow>
                                    <SubTableCellStyled> Define
                                    </SubTableCellStyled>
                                    <SubTableCellStyled>5</SubTableCellStyled>
                                    <SubTableCellStyled> <TextField variant="standard" /> </SubTableCellStyled>
                                    <SubTableCellStyled>
                                        18-Jan-23
                                    </SubTableCellStyled>
                                ...
                                <TableRow>
                                    <SubTableCellStyled> Measure
                                    </SubTableCellStyled>
                                    <SubTableCellStyled>5</SubTableCellStyled>
                                    <SubTableCellStyled> <TextField variant="standard" /> </SubTableCellStyled>
                                    <SubTableCellStyled>  <BasicDatePicker /> </SubTableCellStyled>
                                    <SubTableCellStyled><BasicDatePicker /></SubTableCellStyled>
                                    <SubTableCellStyled>-</SubTableCellStyled>
                                    <SubTableCellStyled>-</SubTableCellStyled>
                                </TableRow>
                ...
                <Grid item xs={12} sm={6} style={{ textAlign: "right", marginTop: '2rem' }}>
                    <ButtonStyle variant="contained">
                        Save & Next
                    </ButtonStyle>
                </Grid>
                        ...
                        <Card className="outerContainer">
                            <CardContent style={{ paddingBottom: 1 }}>
                                <Grid container spacing={2} >
                                    <Grid item xs={4}>
                                        <TextField style={{ width: '100%' }} id="standard-basic" label="Employee Name" variant="standard" />
                                    ...
                                    <Grid item xs={2}>
                                        <TextField style={{ width: '100%' }} id="standard-basic" label="Number" variant="standard" />
                                    </Grid>
                                    <Grid item xs={2}>
                                        <TextField style={{ width: '100%' }} id="standard-basic" label="DOJ" variant="standard" />
                                    </Grid>
                                    <Grid item xs={2}>
                                        <TextField style={{ width: '100%' }} id="standard-basic" label="DOB" variant="standard" />
                                    </Grid>
                                    <Grid item xs={2}>
                                        <TextField style={{ width: '100%' }} id="standard-basic" label="Level" variant="standard" />
                                    </Grid>
                                    {/* <Grid item xs={2}>
                                    ...
                                    {showForm && (
                                        <Grid item xs={3} style={{ textAlign: "right", marginTop: '2rem' }}>
                                            <ButtonStyle variant="contained" style={{ marginRight: '1rem' }}>
                                                Save
                                            </ButtonStyle>
                                            <ButtonStyle variant="contained" onClick={handleCloseWindow}>
                                                Cancel
                                            </ButtonStyle>
                                        </Grid>
                                    )}
                    ...
                    <Table stickyHeader aria-label="simple table">
                        ...
                        <TableHeadStyled>
                            <TableRow>
                                ...
                                <SubTableCell style={{ fontWeight: 'bold' }} >Employee Code</SubTableCell>
                                <SubTableCell style={{ fontWeight: 'bold' }}>Department</SubTableCell>
                                <SubTableCell style={{ fontWeight: 'bold' }} >Certification</SubTableCell>
                                <SubTableCell style={{ fontWeight: 'bold' }}>Role</SubTableCell>
                                <SubTableCell style={{ fontWeight: 'bold' }}>Actions</SubTableCell>
